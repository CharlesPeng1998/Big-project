...
#define MOUSE_ONLY_MOVED						1	//鼠标移动
#define MOUSE_LEFT_BUTTON_CLICK				2	//按下左键
#define MOUSE_LEFT_BUTTON_DOUBLE_CLICK		3	//双击左键
#define MOUSE_RIGHT_BUTTON_CLICK				4	//按下右键
#define MOUSE_RIGHT_BUTTON_DOUBLE_CLICK		5	//双击右键
#define MOUSE_LEFTRIGHT_BUTTON_CLICK			6	//同时按下左右键
#define MOUSE_WHEEL_CLICK					7	//滚轮被按下
#define MOUSE_WHEEL_MOVED_UP					8	//滚轮向上移动
#define MOUSE_WHEEL_MOVED_DOWN				9	//滚轮向下移动
